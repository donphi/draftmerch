    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            .then(data => {
                ...
                // Parsing the body to ensure correct format
                const parsedData = JSON.parse(data.body);
                console.log("Parsed data:", parsedData);
        
                if (parsedData.watermarked_image_url && parsedData.original_image_url && parsedData.filename) {
                    console.log("Original image URL:", parsedData.original_image_url);
                    console.log("Watermarked image URL:", parsedData.watermarked_image_url);
                    console.log("Filename:", parsedData.filename);
        
                    const newImageWrapper = document.createElement('div');
                    newImageWrapper.className = 'image-wrapper checkered-background';
                    newImageWrapper.innerHTML = `<a href="${parsedData.watermarked_image_url}" target="_blank">
                                                    <img src="${parsedData.watermarked_image_url}" alt="Generated Image" id="resultImage" data-filename="${parsedData.filename}">
                                                </a>`;
