    const colorMappings = {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(event) {
                ...
                .then(data => {
                    if (data.url) {
                        imageContainer.innerHTML = `<img src="${data.url}" alt="Generated Image" id="resultImage">`;
    ...
    function removeBackground() {
        ...
        .then(data => {
            if (data.newImageUrl) {
                imageContainer.innerHTML = `<a href="${data.newImageUrl}" target="_blank"><img src="${data.newImageUrl}" alt="Processed Image" id="resultImage"></a>`;
            }
        })
        .catch(error => {
            console.error('Error:', error);
