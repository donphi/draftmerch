...
def remove_background():
    ...
    try:
        ...
        api_key = '54ab9e2fcf1981d0c3c1cf8326726711238be1dea12c77d72c2dbfbfa7284fc58f63219a2ed7505f014efac95f62d1e5'
        ...
        if remove_bg_response.status_code != 200:
            logging.error(f'Background removal API error: {remove_bg_response.status_code} - {remove_bg_response.text}')
        ...
        with open(processed_image_path, 'wb') as f:
            f.write(remove_bg_response.content)

        # Return the URL of the processed image
        return jsonify({'newImageUrl': url_for('static', filename='processed/' + filename)})

    except Exception as e:
        logging.error(f"An error occurred in remove_background: {str(e)}")
